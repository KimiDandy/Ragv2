"""
PROFESSIONAL PROMPT ENGINEERING untuk Direct Single-Step Enhancement System
Comprehensive, detailed, dan production-ready prompts
"""
...
4. **OUTPUT REQUIREMENTS**
   - Format JSON sesuai template
   - Enhancement types sesuai prioritas (formula_discovery, implication_analysis, etc.)
   - Reference sources yang spesifik
   - Confidence score realistis
...
Hasilkan analysis yang PROFESSIONAL dan ACTIONABLE."""
