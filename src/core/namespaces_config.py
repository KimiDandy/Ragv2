...
NAMESPACES: List[Dict[str, any]] = [
    ...
    {
        "id": "client-a-final",
        "name": "Client A - Production Final",
        "description": "Production environment final untuk Client A",
        "client": "client-a",
        "type": "final",
        "is_active": True,
    },
    {
        "id": "client-b-testing-1",
        "name": "Client B - Testing Batch 1",
        "description": "Testing environment pertama untuk Client B",
        "client": "client-b",
        "type": "testing",
        "is_active": True,
    },
    {
        "id": "client-b-final",
        "name": "Client B - Production Final",
        "description": "Production environment final untuk Client B",
        "client": "client-b",
        "type": "final",
        "is_active": True,
    },
